...
def run():
    ...
    #создаем картину для конца
    end_pict = pygame.image.load("D:\PP2python\game\images\end.png").convert_alpha()
    ...
    text_no = myfont.render("No", False, (193, 196, 199))
    text_yes = myfont.render("Yes", False, (115, 132, 148))
    text_yes_rect = text_yes.get_rect(topleft=(280, 150))
    text_no_rect = text_no.get_rect(topleft=(280, 230))
    ...
    while True:
        ...
        if gameplay:
            ...
            screen.fill((0, 0, 0))
            screen.blit(end_pict, (10, 30))
            # screen.blit(text_no, (280, 230))
            # screen.blit(text_yes, (280, 150))
